...
export const UNESCAPE_YARN = 'https://yarnpkg.com/en/package/@favware/unescape';
export const UNESCAPE_GITHUB = 'https://www.github.com/favware/node-packages/tree/master/packages/unescape';

export const CONVERTER_YARN = 'https://yarnpkg.com/en/package/@favware/converter';
export const CONVERTER_GITHUB = 'https://www.github.com/favware/node-packages/tree/master/packages/converter';

export const QUERYSTRING_YARN = 'https://yarnpkg.com/en/package/@favware/querystring';
export const QUERYSTRING_GITHUB = 'https://www.github.com/favware/node-packages/tree/master/packages/querystring';

export const MILKY_TSLINT_YARN = 'https://yarnpkg.com/en/package/@favware/milky-tslint';
export const MILKY_TSLINT_GITHUB = 'https://www.github.com/favware/node-packages/tree/master/packages/milky-tslint';

export const YAMLREADER_YARN = 'https://yarnpkg.com/en/package/@favware/yamlreader';
export const YAMLREADER_GITHUB = 'https://www.github.com/favware/node-packages/tree/master/packages/yamlreader';

export const ZALGO_YARN = 'https://yarnpkg.com/en/package/@favware/zalgo';
